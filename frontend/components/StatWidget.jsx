...
const StatWidget = ({ ongoing, completed, pending }) => {
  return (
    ...
    <h1 className='pb-4 pt-4 font-semibold text-xl'>Shipment Statistics</h1>
      ...
      <div className='grid grid-cols-2 justify-end w-1/2'>
          ...
          <div className='flex flex-col'>
            <div className='flex mx-auto items-center gap-1 text-xs'><p className='w-2 h-2 rounded-full bg-blue-400'></p> Completed</div>
            <h1 className='flex mx-auto text-4xl font-semibold'>{completed}</h1>
          </div>
          <div className='flex flex-col'>
